#Based on https://github.com/ufal/multilexnorm2021/blob/master/model/model.py
...
class Model(pl.LightningModule):
    def __init__(self, args, dataset):
        ...
        #self.config = T5Config.from_json_file('./checkpoints/fi/byt5-small_wiki_4_epoch-8/config.json')
        #self.model = T5ForConditionalGeneration.from_pretrained('./checkpoints/fi/byt5-small_wiki_4_epoch-8/pytorch_model.bin',config=self.config)
